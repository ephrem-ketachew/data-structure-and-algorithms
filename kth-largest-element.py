...
# k = KthLargest(3, [29, 58, 45, 31, 18, 80, 36, 13, 64])
# for i in range(10):
#     print(k._remove())
#     # print(k.heap)
...
#                     self.heap[parent_index], self.heap[max_index] = self.heap[max_index], self.heap[parent_index]
...
#             kth_largest = self._remove()
#             removed_items.append(kth_largest)
#         for val in removed_items:
#             self._insert(val)
#         return kth_largest
