...
class Router:
    ...
    def __init__(self, memoryLimit: int):
        ...
        self.queue = deque()
        self.seen = set()
        self.destinaitons = defaultdict(deque)
    ...
    def addPacket(self, source: int, destination: int, timestamp: int) -> bool:
        ...
        if len(self.queue) == self.memory_limit:
            ...
            self.destinaitons[old_packet[1]].popleft()
        self.queue.append(packet)
        self.seen.add(packet)
        self.destinaitons[destination].append(timestamp)
        return True
    ...
    def getCount(self, destination: int, startTime: int, endTime: int) -> int:
        start_idx = bisect.bisect_left(self.destinaitons[destination], startTime)
        end_idx = bisect.bisect_right(self.destinaitons[destination], endTime)
